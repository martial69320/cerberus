...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    ...
    switch (slot)
    {
        case EQUIPMENT_SLOT_HEAD: return  LANG_TRANSMO_HEAD;// session->GetTrinityString(LANG_SLOT_NAME_HEAD);
        case EQUIPMENT_SLOT_SHOULDERS: return  LANG_TRANSMO_SHOULDERS;// session->GetTrinityString(LANG_SLOT_NAME_SHOULDERS);
        case EQUIPMENT_SLOT_BODY: return  LANG_TRANSMO_SHIRT;// session->GetTrinityString(LANG_SLOT_NAME_BODY);
        case EQUIPMENT_SLOT_CHEST: return  LANG_TRANSMO_CHEST;// session->GetTrinityString(LANG_SLOT_NAME_CHEST);
        case EQUIPMENT_SLOT_WAIST: return  LANG_TRANSMO_WAIST;// session->GetTrinityString(LANG_SLOT_NAME_WAIST);
        case EQUIPMENT_SLOT_LEGS: return  LANG_TRANSMO_LEGS;// session->GetTrinityString(LANG_SLOT_NAME_LEGS);
        case EQUIPMENT_SLOT_FEET: return  LANG_TRANSMO_FEET;// session->GetTrinityString(LANG_SLOT_NAME_FEET);
        case EQUIPMENT_SLOT_WRISTS: return  LANG_TRANSMO_WRISTS;// session->GetTrinityString(LANG_SLOT_NAME_WRISTS);
        case EQUIPMENT_SLOT_HANDS: return  LANG_TRANSMO_HANDS;// session->GetTrinityString(LANG_SLOT_NAME_HANDS);
        case EQUIPMENT_SLOT_BACK: return  LANG_TRANSMO_BACK;// session->GetTrinityString(LANG_SLOT_NAME_BACK);
        case EQUIPMENT_SLOT_MAINHAND: return  LANG_TRANSMO_MAIN_HAND;// session->GetTrinityString(LANG_SLOT_NAME_MAINHAND);
        case EQUIPMENT_SLOT_OFFHAND: return  LANG_TRANSMO_OFFHAND;// session->GetTrinityString(LANG_SLOT_NAME_OFFHAND);
        case EQUIPMENT_SLOT_RANGED: return  LANG_TRANSMO_RANGED;// session->GetTrinityString(LANG_SLOT_NAME_RANGED);
        case EQUIPMENT_SLOT_TABARD: return  LANG_TRANSMO_TABARD;// session->GetTrinityString(LANG_SLOT_NAME_TABARD);
        default: return NULL;
    }
}
