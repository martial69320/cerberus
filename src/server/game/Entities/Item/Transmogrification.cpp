...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    ...
    switch (slot)
    {
        ...
        case EQUIPMENT_SLOT_LEGS: return  "Jambières";// session->GetTrinityString(LANG_SLOT_NAME_LEGS);
        case EQUIPMENT_SLOT_FEET: return  "Pieds";// session->GetTrinityString(LANG_SLOT_NAME_FEET);
        case EQUIPMENT_SLOT_WRISTS: return  "Brassards";// session->GetTrinityString(LANG_SLOT_NAME_WRISTS);
        case EQUIPMENT_SLOT_HANDS: return  "Gants";// session->GetTrinityString(LANG_SLOT_NAME_HANDS);
        ...
        case EQUIPMENT_SLOT_RANGED: return  "Arme a distance";// session->GetTrinityString(LANG_SLOT_NAME_RANGED);
