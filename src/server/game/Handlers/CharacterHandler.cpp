...
//        sWorld->UpdateCharacterNameData(pCurrChar->GetGUIDLow() );
        ...
        if(result)
        {
            ...
            sWorld->AddCharacterInfo(pCurrChar->GetGUID(), nameUpdate_AT_LOGIN_UPDATE_NAME, pCurrChar->GetAccountId(), pCurrChar->getGender(), pCurrChar->getRace(), pCurrChar->getClass(), pCurrChar->getLevel());
        }
