...
//        sWorld->UpdateCharacterNameData(pCurrChar->GetGUIDLow() );
        ...
        if(result)
        {
            ...
            sWorld->AddCharacterInfo(pCurrChar->GetGUID(), nameUpdate_AT_LOGIN_UPDATE_NAME, pCurrChar->AccountId, pCurrChar->getGender(), pCurrChar->getRace(), pCurrChar->getClass(), pCurrChar->getLevel());
        }
